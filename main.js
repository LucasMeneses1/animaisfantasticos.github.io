...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ initNavTabs)\n/* harmony export */ });\nfunction initNavTabs() {\n  var animaisImgs = document.querySelectorAll(\"[data-tab='menu'] img\");\n  var animaisArtigos = document.querySelectorAll(\"[data-tab='conteudo'] .artigo\");\n  animaisArtigos[0].classList.add(\"ativo\");\n  if (animaisImgs.length && animaisArtigos.length) {\n    var tabAtiva = function tabAtiva(index) {\n      animaisArtigos.forEach(function (element) {\n        element.classList.remove(\"ativo\");\n      });\n      var direcaoAnimacao = animaisArtigos[index].dataset.anime;\n      animaisArtigos[index].classList.add(\"ativo\", direcaoAnimacao);\n      console.log(animaisArtigos[index]);\n    };\n    animaisImgs.forEach(function (element, index) {\n      element.addEventListener(\"click\", function () {\n        tabAtiva(index);\n      });\n    });\n  }\n}\n\n//# sourceURL=webpack://4--animais_fantasticos/./js/modules/tab-nav.js?");
